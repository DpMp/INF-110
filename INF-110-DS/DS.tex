...
\begin{table}[h]
    ...
    \begin{tabular}{m{7.5cm} m{3.7cm}}
        ...
        \end{tikzpicture}\\
        \centering
        $Differenz: A \backslash B = \{x \in A \vst x \notin B\}$ &
        \begin{tikzpicture}
...
\begin{itemize}
    ...
    \begin{tabular}{l r}
        ...
        \end{pmatrix}$
    \end{tabular}
    \item Zyklenschreibweise: $\pi = (1 \; 2 \; 3)(4) = (1 \; 2 \; 3)$, wobei Zyklen disjunkt sind 
\end{itemize}
\begin{center}
    \begin{tikzpicture}
...
\pr{
    ...
    IV: $f': A \backslash \{a\} \to B \backslash \{f(a)\}, f'(a') = f(a')$ ist bijektiv.
